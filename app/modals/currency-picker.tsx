...
/** All active ISO 4217 currency codes in common use. Decimal precision is not stored here —
 * it's derived live per-currency via Intl in src/lib/money.ts wherever an amount is formatted. */
const CURRENCIES = [
